...
function LoginForm() {
  ...
  return (
    <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-6 shadow-2xl">
      <h2 className="mb-1 text-sm font-medium text-zinc-200">Sign in</h2>
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            <h1 className="text-xl font-semibold text-zinc-100">Broker Response</h1>
        ...
        <Suspense fallback={
          <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-6">
            <div className="h-32 animate-pulse rounded-md bg-zinc-800" />
          </div>
        }>
          <LoginForm />
        </Suspense>
